...
docker-build-frontend:
	DOCKER_PLATFORM=$(DOCKER_PLATFORM) REGISTRY=$(REGISTRY) ./scripts/docker-build-frontend.sh

docker-push:
	DOCKER_PLATFORM=$(DOCKER_PLATFORM) REGISTRY=$(REGISTRY) PUSH=true ./scripts/docker-build.sh

docker-push-frontend:
	DOCKER_PLATFORM=$(DOCKER_PLATFORM) REGISTRY=$(REGISTRY) PUSH=true ./scripts/docker-build-frontend.sh
